...
PROJECT_APPS = ['myapp','tempinheritance','staticRender','templateForms', 'crud', 'classBased', 'api']
...
#STATIC_ROOT = "static" #create a static folder outside which contains every static folder.

MEDIA_URL = 'media/'
MEDIA_ROOT = "media" #Create a folder named as media
